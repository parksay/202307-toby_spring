...
public class UserDaoJdbc511 implements UserDao511 {

    private JdbcTemplate jdbcTemplate;
    private RowMapper<User511> rowMapper = new RowMapper<User511>() {
        @Override
        public User511 mapRow(ResultSet rs, int rowNum) throws SQLException {
            User511 user = new User511();
            user.setId(rs.getString("id"));
            user.setName(rs.getString("name"));
            user.setPassword(rs.getString("password"));
            user.setLevel(Level511.valueOf(rs.getInt("level")));
    ...
    public void update(User511 user) {
