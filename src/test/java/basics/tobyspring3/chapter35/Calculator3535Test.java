...
public class Calculator3535Test {

    Calculator3535 calculator;
    String path;

    @BeforeEach
    public void setUp() {
        Calculator3535 calculator = new Calculator3535();
    ...
    @Test
    public void calcDivTest() throws IOException {
        double sum = calculator.calcDiv(path);
